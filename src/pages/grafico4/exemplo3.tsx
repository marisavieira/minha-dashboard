...
export default class Example extends PureComponent {
  ...
  render() {
        ...
        return (
          <Container>
            <ContentHeader title="Gráfico de dispersão faltas vs notas turma com categorização entre as 4 atividades distintas" link1="Grafico4Vs1" link2="/Grafico4Vs2" link3=""/>
          ...
          <Grafico>
            <Header>
              ...
              >
                ...
                <Scatter name="Atividade 1" fill="transparent" stroke="#fdcb6e"/>
