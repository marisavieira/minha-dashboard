...
export default class Example extends PureComponent {
  ...
  render() {
    return (
      <Container>
        <ContentHeader title="Gráfico de barras com análise da nota de cada aluno vs a média da turma" link1="Grafico3Vs1" link2="Grafico3Vs2" link3=""/>
      ...
      <Grafico>
        ...
        >
          ...
          <XAxis orientation="top" type="number" tickSize={5} ticks={[0.5, 1, 1.5, 2, 2.5]}/>
